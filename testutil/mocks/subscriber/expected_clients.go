...
func (mr *MockRpcHttpClientMockRecorder) Status(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRpcHttpClientMockRecorder) Subscribe(ctx, subscriber, query interface{}, outCapacity ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRpcHttpClientMockRecorder) Unsubscribe(ctx, subscriber, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestHttpQueryMockRecorder) NeutronInterchainQueriesRegisteredQueries(params interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRestHttpQueryMockRecorder) NeutronInterchainQueriesRegisteredQuery(params interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{params}, opts...)
