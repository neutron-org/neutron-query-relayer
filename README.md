...
| `RELAYER_NEUTRON_CHAIN_SIGN_MODE_STR `     | `string`                                             | [see](https://docs.cosmos.network/master/core/transactions.html) also consider use short variattin, e.g. `dirert`                                                                                                                                                                                                                                                                                                                         | required |
