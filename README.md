...
|--------------------------------------------|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| `RELAYER_REGISTRY_ADDRESSES`               | `string`                                             | a list of smart-contract addresses for which the relayer processes interchain queries                                                                                                                                                                                                                                                                                                                                                                                                            | required |
...
| `RELAYER_NEUTRON_CHAIN_CLIENT_ID `         | `string`                                             | is the IBC client ID for an IBC connection between Neutron chain and target chain (where the result was obtained from)                                                                                                                                                                                                                                                                                                                                                                                                                           | required |
...
| `RELAYER_TARGET_CHAIN_CONNECTION_ID`       | `time`                                               | target chain conntetion ID                                                                                                                                                                                                                                                                                                                                                                                                                       | required |
| `RELAYER_TARGET_CHAIN_CLIENT_ID `          | `string`                                             | is the IBC client ID for an IBC connection between Neutron chain and target chain (where the result was obtained from)                                                                                                                                                                                                                                                                                                                                                                                                                             | required |
