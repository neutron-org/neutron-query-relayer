...
| `RELAYER_DB_PATH`                          | `string`                                                       | path to leveldb storage, will be created on given path if doesn't exists <br/> (NOTE: required if `RELAYER_ALLOW_TX_QUERIES` is `true`                                                                                                                                                                                                                                                                                                      | optional |
...
| `RELAYER_NEUTRON_CHAIN_KEY `               | `string`                                                       | neutron chain keys name                                                                                                                                                                                                                                                                                                                                                                                                                     | required |
...
| `RELAYER_NEUTRON_CHAIN_ALLOW_KV_CALLBACKS` | `bool`                                                         | if `true`, will pass proofs as sudo callbacks to contracts                                                                                                                                                                                                                                                                                                                                                                                  | required |
