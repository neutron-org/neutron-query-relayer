...
func NewDefaultRelayer(logger *zap.Logger, cfg config.NeutronQueryRelayerConfig) (*relay.Relayer, <-chan relay.PendingSubmittedTxInfo) {
	...
	targetQuerier, err := tdmquerier.NewQuerier(targetClient, cfg.TargetChain.ChainID, cfg.TargetChain.ValidatorAccountPrefix)
	if err != nil {
