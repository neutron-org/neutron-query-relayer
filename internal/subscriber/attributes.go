...
const (
	...
	connectionIdAttr = "neutron_message." + types.AttributeKeyConnectionID
	// queryIdAttr is the key of the Neutron's custom message event's attribute that contains the
	// incoming ICQ ID.
	queryIdAttr = "neutron_message." + types.AttributeKeyQueryID
	...
	kvKeyAttr = "neutron_message." + types.AttributeKeyKVQuery
